module.exports = {
  ...
  organizationName: 'peaceiris', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    navbar: {
      ...
      links: [
        ...
        {
          href: 'https://github.com/peaceiris/test-docusaurus',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/peaceiris/test-docusaurus/edit/master/website/',
        },
        theme: {
